...
class TestPlayerDismissals(SentenceParserAssert):
    ...
    def setUp(self):
        ...
        self.expected = '{"player_dismissals": {"word_by": "by", "word_in": "in", "dismissals": "bowled", "word_dismissals": "dismissals", "team": "india"}}'
