...
class TestMatchesAndClauses(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.expected_matches_played_by_a_team = '{"matches": {"word_in": "in", "year": "2011", "clause_batting_order": {"word_batting": "batting", "word_batting_order": "second"}, "clause_played_by_team": {"word_played": "played", "word_by": "by", "team": {"team1": "india"}}, "word_matches": "matches"}}'

        self.input_matches_played_by_two_teams = 'matches played by india and sri lanka'
        self.expected_matches_played_by_two_teams = '{"matches": {"clause_played_by_team": {"word_played": "played", "team_B": {"team": {"team2": "lanka", "team1": "sri"}}, "word_by": "by", "word_and": "and", "team_A": {"team": {"team1": "india"}}}, "word_matches": "matches"}}'

        self.input_matches_won_by_a_team_against_a_team = 'matches won by india against pakistan in world cup'
        self.expected_matches_won_by_a_team_against_a_team = '{"matches": {"word_in": "in", "series": {"series1": "world", "series2": "cup"}, "clause_result_against_team": {"word_won_lost": "won", "word_by": "by",  "team_A": {"team": {"team1": "india"}},  "team_B": {"team": {"team1": "pakistan"}}, "word_against": "against"}, "word_matches": "matches"}}'
