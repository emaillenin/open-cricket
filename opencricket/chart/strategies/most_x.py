    ...
    return """
        ...
        """ % (base_syntax_most_x,
               syntax_expansions.expand_with_filters(base_syntax_most_x,
                                                     ['word_against team', 'word_in word_a single_innings',
                                                      'word_in word_a single_match',
                                                      'word_in word_a single_series',
                                                      'word_in word_a single_year',
                                                      'word_in word_a single_ground']),
               ...
               word_config.cfg_helpers['single_innings'],
               word_config.cfg_helpers['single_match'],
               word_config.cfg_helpers['single_series'],
               word_config.cfg_helpers['single_year'],
               word_config.cfg_helpers['single_ground'],
