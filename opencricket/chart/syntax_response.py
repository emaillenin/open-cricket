...
class SyntaxResponse:
    @staticmethod
    def build_response(syntax_string, suggested, suggested_search=None, did_you_mean=None, related_searches=None):
        ...
        if related_searches is not None: response_json.update({"related_search": related_searches})
