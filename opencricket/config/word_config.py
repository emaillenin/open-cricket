...
cfg_helpers = {
    ...
    'words_single_innings': "words_single_innings -> 'single' 'innings'",
    'words_single_match': "words_single_match -> 'single' 'match'",
    'words_single_series': "words_single_series -> 'single' 'series'",
    'words_single_ground': "words_single_ground -> 'single' 'ground'",
    'words_single_year': "words_single_year -> 'single' 'year'",
    ...
    'words_wicket_keeper': "words_wicket_keeper -> 'wicket' 'keeper'",
