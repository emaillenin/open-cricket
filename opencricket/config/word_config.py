...
cfg_helpers = {
    ...
    'single_innings': "single_innings -> 'single' 'innings'",
    'single_match': "single_match -> 'single' 'match'",
    'single_series': "single_series -> 'single' 'series'",
    'single_ground': "single_ground -> 'single' 'ground'",
    'single_year': "single_year -> 'single' 'year'",
